...
export default function SocialMedia() {
  return (
    <div>
      <div className="flex pl-2 mt-2 space-x-2">
        <button onClick={() => window.open("https://www.facebook.com/WestinNewOrleans/ ")} className="cursor-pointer bg-white  font-bold py-2 px-2 rounded-full">
        ...
        <button onClick={() => window.open("https://twitter.com/westinnola")} className="cursor-pointer bg-white  font-bold py-2 px-2 rounded-full">
